...
| + to_dict() : dict|
        ^                      
        |   Inherited classes from the base class `BaseModel`                 
| Place | User | Review |City | State | Amenity |
|:----------|:----------|:----------|:----------|:----------|:----------|
| + city_id : str | + email : str | + place_id : str|+ name : str |  + name : str |  + name : str |
| + user_id : str| + password : str | + user_id : str|+ state_id : str|
| + name : str| + first_name : str | + text : str|
| + description : str| + last_name : str|
| + number_rooms : int|
...
- **OBENG DANKWAH EDWARD** <[godcandidate](https://github.com/godcandidate)>
- **KREMLIN AMPONSAH** <[AI-Amponsah](https://github.com/[AI-Amponsah)>
